      ...
      <section id="goldwasser">
        ...
        <div class="comments">
          ...
          <?php
            ...
            $stmt->bindValue(":article_id", "goldwasser");
            ...
            while($row = $returned_set->fetchArray(SQLITE3_ASSOC)) {
              ...
              echo "<small> ~ " . $row['author_username'] . "</small>";
              echo "</li>";
            }
      ...
      <section id="residue">
        ...
        <div class="comments">
          ...
          <?php
            ...
            $stmt->bindValue(":article_id", "residue");
      ...
      <section id="symbols">
        ...
        <div class="comments">
          ...
          <?php
            ...
            $stmt->bindValue(":article_id", "symbols");
      ...
      <section id='shamir'>
        ...
        <div class="comments">
          ...
          <?php
            ...
            $stmt->bindValue(":article_id", "shamir");
          ...
          <?php if (isset($_SESSION["username"])) { ?>
            <form method="POST" action="/comment.php" id="usrform">
              <input hidden=true name="article" value="shamir">
              <input type="text" name="content">
              <input type="submit" value="Wyślij">
            </form>
          <?php } ?>
      ...
      <section id='lagrange'>
        ...
        <div class="comments">
          ...
          <?php
            ...
            $stmt->bindValue(":article_id", "lagrange");
          ...
          <?php if (isset($_SESSION["username"])) { ?>
            <form method="POST" action="/comment.php" id="usrform">
              <input hidden=true name="article" value="lagrange">
              <input type="text" name="content">
              <input type="submit" value="Wyślij">
            </form>
          <?php } ?>
      ...
      <section id="example">
        ...
        <div class="comments">
          ...
          <?php
            ...
            $stmt->bindValue(":article_id", "example");
          ...
          <?php if (isset($_SESSION["username"])) { ?>
            <form method="POST" action="/comment.php" id="usrform">
              <input hidden=true name="article" value="example">
              <input type="text" name="content">
              <input type="submit" value="Wyślij">
            </form>
          <?php } ?>
